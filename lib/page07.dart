...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Page07(title: 'ขนมครก'),
    );
  }
}

class Page07 extends StatefulWidget {
  const Page07({Key? key, required this.title}) : super(key: key);
...
class Page03State extends State<Page07> {
  // ฟังก์ชันเปิด YouTube ลิงก์
  void _launchYouTube() async {
  final Uri url = Uri.parse(
      'https://www.youtube.com/watch?v=oOQbxnZOISw&pp=ygUh4Liq4Lit4LiZ4LiX4Liz4LiC4LiZ4Lih4LiE4Lij4LiB');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 70, 219, 2), // สีพื้นหลังของ AppBar
      ),
      body: Column(
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // คำอธิบายเมนูอาหาร
                  Text(
                    'ขนมครก เป็นขนมไทยโบราณเวลาจะรับประทานต้องแคะออกมาเป็นแผ่นวงกลม แล้วมักวางประกบกันตอนรับประทาน',
